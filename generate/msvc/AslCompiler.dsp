...
# ADD CPP /nologo /Gd /W4 /Gi /Ob1 /Gf /I "..\..\source\include" /I "..\..\source\compiler" /I "." /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_CONSOLE" /D "__STDC__" /D "YY_NEVER_INTERACTIVE" /D "ACPI_ASL_COMPILER" /FD /c
...
# ADD CPP /nologo /Gd /W4 /Gm /Gi /Zi /Od /Oy /Ob1 /Gf /I "..\..\source\include" /I "..\..\source\compiler" /I "." /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_CONSOLE" /D "__STDC__" /D "YY_NEVER_INTERACTIVE" /D "ACPI_ASL_COMPILER" /FD /GZ /c
# SUBTRACT CPP /Fr
...
BuildCmds= \
	bison -d -pAslCompiler -v $(InputPath) -vd -o$(InputName).y.c
...
BuildCmds= \
	bison -d -pDtParser -v $(InputPath) -vd -o$(InputName).y.c
...
BuildCmds= \
	bison -d -pPrParser -v $(InputPath) -vd -o$(InputName).y.c
